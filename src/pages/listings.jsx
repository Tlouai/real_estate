      ...
      <section className="listings">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <div className="thumb">
              <p className="total-images"><i className="far fa-images"></i><span>4</span></p>
            ...
            <p className="location"><i className="fa fa-map-marker-alt"></i><span>Dubai, UAE</span></p>
            <div className="flex">
      ...
      <footer className="footer">
        <section className="flex">
          <div className="box">
            ...
            <a href="tel:111222333"><i className="fas fa-phone"></i><span>111222333</span></a>
            <a href="mailto:louai@gmail.com"><i className="fas fa-envelope"></i><span>louai@gmail.com</span></a>
